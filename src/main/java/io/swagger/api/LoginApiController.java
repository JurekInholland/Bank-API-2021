...
public class LoginApiController implements LoginApi {
    ...
    public ResponseEntity<LoginToken> loginUser(@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody UserLogin body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<LoginToken>(objectMapper.readValue("{\n  \"authtoken\" : \"xx508xx63817x752xx74004x30705xx92x58349x5x78f5xx34xxxxx51\"\n}", LoginToken.class), HttpStatus.NOT_IMPLEMENTED);
            } catch (IOException e) {
